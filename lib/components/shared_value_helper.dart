...
final SharedValue<String> photo = SharedValue(
  value: "", // initial value
  key: "photo", // disk storage key for shared_preferences
);
...
final SharedValue<String> role_name = SharedValue(
  value: "", // initial value
  key: "role_name", // disk storage key for shared_preferences
);
...
final SharedValue<int> user_points = SharedValue(
  value: 0, // initial value
  key: "user_points", // disk storage key for shared_preferences
);

final SharedValue<int> user_stars = SharedValue(
  value: 0, // initial value
  key: "user_stars", // disk storage key for shared_preferences
);
