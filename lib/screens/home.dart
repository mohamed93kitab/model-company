...
import 'package:model_company/dummy_data/messengers.dart';
...
import 'package:model_company/screens/filter.dart';
import 'package:model_company/screens/flash_deal_list.dart';
import 'package:model_company/screens/messenger_list.dart';
import 'package:badges/badges.dart' as badges;
import 'package:model_company/screens/top_selling_products.dart';
import 'package:model_company/screens/category_products.dart';
import 'package:model_company/screens/category_list.dart';
import 'package:model_company/ui_sections/drawer.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:carousel_slider/carousel_slider.dart';
import 'package:model_company/repositories/sliders_repository.dart';
import 'package:model_company/repositories/category_repository.dart';
import 'package:model_company/repositories/product_repository.dart';
import 'package:model_company/app_config.dart';

import 'package:model_company/ui_elements/product_card.dart';
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Container(
                      decoration: BoxDecorations.buildBoxDecoration_1(radius: 88),
                      child: Container(
                          child: ClipRRect(
                              borderRadius: BorderRadius.circular(88),
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      softWrap: true,
                      style:
                      TextStyle(fontSize: 12, color: MyTheme.secondary_color),
                    ),
                  ),
                ],
              ),
            ...
            builder: (BuildContext context) {
              return Padding(
                padding: EdgeInsets.only(
                    left: 16.0, right: 16, top: 20.0, bottom: 20),
                child: Container(
                  //color: Colors.amber,
