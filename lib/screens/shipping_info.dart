...
import 'package:model_company/custom/fade_network_image.dart';
import 'package:model_company/custom/lang_text.dart';
import 'package:model_company/custom/scroll_to_hide_widget.dart';
...
import 'package:model_company/repositories/pickup_points_repository.dart';
import 'package:model_company/repositories/shipping_repository.dart';
import 'package:model_company/screens/checkout.dart';
...
import 'package:model_company/repositories/address_repository.dart';
  ...
  Column buildCartSellerListItem(int index, BuildContext context) {
    return Column(
            ...
            children: [
              ...
              SizedBox(height: 5,),
              Opacity(opacity: 0, child: buildChooseShippingOptions(context, index)),
              SizedBox(height: 10,),
              buildShippingListBody(index),
            ],
          );
