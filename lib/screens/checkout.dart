...
import 'package:model_company/screens/order_list.dart';
import 'package:model_company/screens/stripe_screen.dart';
import 'package:model_company/screens/paypal_screen.dart';
import 'package:model_company/screens/razorpay_screen.dart';
import 'package:model_company/screens/paystack_screen.dart';
import 'package:model_company/screens/iyzico_screen.dart';
import 'package:model_company/screens/bkash_screen.dart';
import 'package:model_company/screens/nagad_screen.dart';
import 'package:model_company/screens/sslcommerz_screen.dart';
import 'package:model_company/screens/flutterwave_screen.dart';
import 'package:flutter_icons/flutter_icons.dart';
import 'package:model_company/helpers/shared_value_helper.dart';
import 'package:model_company/repositories/payment_repository.dart';
import 'package:model_company/repositories/cart_repository.dart';
import 'package:model_company/repositories/coupon_repository.dart';
...
import 'package:model_company/screens/offline_screen.dart';
            ...
            decoration: InputDecoration(
                ...
                enabledBorder: OutlineInputBorder(
                  ...
                  borderRadius: BorderRadius.only(
                    topLeft: app_language_rtl.$ ? Radius.circular(0.0) : Radius.circular(8.0),
                    bottomLeft: app_language_rtl.$ ? Radius.circular(0.0) : Radius.circular(8.0),
                    topRight: app_language_rtl.$ ? Radius.circular(8.0) : Radius.circular(0.0),
                    bottomRight: app_language_rtl.$ ? Radius.circular(8.0) : Radius.circular(0.0),
                  ),
                ),
        ...
        !_coupon_applied
            ? Container(
                ...
                decoration: BoxDecoration(
                  color: MyTheme.accent_color,
                  borderRadius: BorderRadius.only(
                    topLeft: app_language_rtl.$ ? Radius.circular(8.0) : Radius.circular(0.0),
                    bottomLeft: app_language_rtl.$ ? Radius.circular(8.0) : Radius.circular(0.0),
                    topRight: app_language_rtl.$ ? Radius.circular(0.0) : Radius.circular(8.0),
                    bottomRight: app_language_rtl.$ ? Radius.circular(0.0) : Radius.circular(8.0),
                  ),
                ),
                child: TextButton(
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  _paymentTypeList[index].title == 'Cash on delivery' ? AppLocalizations.of(context).cash_on_delivery : _paymentTypeList[index].title,
